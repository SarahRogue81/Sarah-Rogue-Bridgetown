...
`;var ri={small:"s",medium:"m",large:"l"},li=new Set;function Tt(t,o){o in ri&&!li.has(`${t}:${o}`)&&(li.add(`${t}:${o}`),console.warn(`[${t}] size="${o}" is deprecated. Use size="${ri[o]}" instead. The long-form value will be removed in the next major version.`))}var Ht=U`
  :host([size='xs']) {
      ...
      >
        ...
        ${s.length>0?A`
              <div part="swatches" class="swatches">
                ${s.map(g=>{let h=this.parseColor(g.color);return h?A`
                    <div
                      part="swatch"
...
`;var Wt=Math.min,Xt=Math.max,Po=Math.round,te=Math.floor,Zt=t=>({x:t,y:t}),Al={left:"right",right:"left",bottom:"top",top:"bottom"};function ga(t,o,e){return Xt(t,Wt(o,e))}function po(t,o){return typeof t=="function"?t(o):t}function oo(t){return t.split("-")[0]}function wo(t){return t.split("-")[1]}function ba(t){return t==="x"?"y":"x"}function xe(t){return t==="y"?"height":"width"}function Yt(t){let o=t[0];return o==="t"||o==="b"?"y":"x"}function We(t){return ba(Yt(t))}function Di(t,o,e){e===void 0&&(e=!1);let a=wo(t),i=We(t),r=xe(i),l=i==="x"?a===(e?"end":"start")?"right":"left":a==="start"?"bottom":"top";return o.reference[r]>o.floating[r]&&(l=_o(l)),[l,_o(l)]}function zi(t){let o=_o(t);return[Ue(t),o,Ue(o)]}function Ue(t){return t.includes("start")?t.replace("start","end"):t.replace("end","start")}var Ri=["left","right"],Ei=["right","left"],Gl=["top","bottom"],Ul=["bottom","top"];function xl(t,o,e){switch(t){case"top":case"bottom":return e?o?Ei:Ri:o?Ri:Ei;case"left":case"right":return o?Gl:Ul;default:return[]}}function Vi(t,o,e,a){let i=wo(t),r=xl(oo(t),e==="start",a);return i&&(r=r.map(l=>l+"-"+i),o&&(r=r.concat(r.map(Ue)))),r}function _o(t){let o=oo(t);return Al[o]+t.slice(o.length)}function Wl(t){var o,e,a,i;return{top:(o=t.top)!=null?o:0,right:(e=t.right)!=null?e:0,bottom:(a=t.bottom)!=null?a:0,left:(i=t.left)!=null?i:0}}function ha(t){return typeof t!="number"?Wl(t):{top:t,right:t,bottom:t,left:t}}function Lo(t){let{x:o,y:e,width:a,height:i}=t;return{width:a,height:i,top:e,left:o,right:o+a,bottom:e+i,x:o,y:e}}function Mi(t,o,e){let{reference:a,floating:i}=t,r=Yt(o),l=We(o),s=xe(l),n=oo(o),g=r==="y",h=a.x+a.width/2-i.width/2,u=a.y+a.height/2-i.height/2,m=a[s]/2-i[s]/2,C;switch(n){case"top":C={x:h,y:a.y-i.height};break;case"bottom":C={x:h,y:a.y+a.height};break;case"right":C={x:a.x+a.width,y:u};break;case"left":C={x:a.x-i.width,y:u};break;default:C={x:a.x,y:a.y}}let I=wo(o);return I&&(C[l]+=m*(I==="end"?1:-1)*(e&&g?-1:1)),C}async function Ji(t,o){var e;o===void 0&&(o={});let{x:a,y:i,platform:r,rects:l,elements:s,strategy:n}=t,{boundary:g="clippingAncestors",rootBoundary:h="viewport",elementContext:u="floating",altBoundary:m=!1,padding:C=0}=po(o,t),I=ha(C),v=s[m?u==="floating"?"reference":"floating":u],y=Lo(await r.getClippingRect({element:(e=await(r.isElement==null?void 0:r.isElement(v)))==null||e?v:v.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(s.floating)),boundary:g,rootBoundary:h,strategy:n})),W=u==="floating"?{x:a,y:i,width:l.floating.width,height:l.floating.height}:l.reference,k=await(r.getOffsetParent==null?void 0:r.getOffsetParent(s.floating)),E=await(r.isElement==null?void 0:r.isElement(k))&&await(r.getScale==null?void 0:r.getScale(k))||{x:1,y:1},$=Lo(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:s,rect:W,offsetParent:k,strategy:n}):W);return{top:(y.top-$.top+I.top)/E.y,bottom:($.bottom-y.bottom+I.bottom)/E.y,left:(y.left-$.left+I.left)/E.x,right:($.right-y.right+I.right)/E.x}}var Zl=50,ji=async(t,o,e)=>{let{placement:a="bottom",strategy:i="absolute",middleware:r=[],platform:l}=e,s=l.detectOverflow?l:{...l,detectOverflow:Ji},n=await(l.isRTL==null?void 0:l.isRTL(o)),g=await l.getElementRects({reference:t,floating:o,strategy:i}),{x:h,y:u}=Mi(g,a,n),m=a,C=0,I={};for(let L=0;L<r.length;L++){let v=r[L];if(!v)continue;let{name:y,fn:W}=v,{x:k,y:E,data:$,reset:V}=await W({x:h,y:u,initialPlacement:a,placement:m,strategy:i,middlewareData:I,rects:g,platform:s,elements:{reference:t,floating:o}});h=k??h,u=E??u,I[y]={...I[y],...$},V&&C<Zl&&(C++,typeof V=="object"&&(V.placement&&(m=V.placement),V.rects&&(g=V.rects===!0?await l.getElementRects({reference:t,floating:o,strategy:i}):V.rects),{x:h,y:u}=Mi(g,m,n)),L=-1)}return{x:h,y:u,placement:m,strategy:i,middlewareData:I}},Ti=t=>({name:"arrow",options:t,async fn(o){let{x:e,y:a,placement:i,rects:r,platform:l,elements:s,middlewareData:n}=o,{element:g,padding:h=0}=po(t,o)||{};if(g==null)return{};let u=ha(h),m={x:e,y:a},C=We(i),I=xe(C),L=await l.getDimensions(g),v=C==="y",y=v?"top":"left",W=v?"bottom":"right",k=v?"clientHeight":"clientWidth",E=r.reference[I]+r.reference[C]-m[C]-r.floating[I],$=m[C]-r.reference[C],V=await(l.getOffsetParent==null?void 0:l.getOffsetParent(g)),rt=V?V[k]:0;(!rt||!await(l.isElement==null?void 0:l.isElement(V)))&&(rt=s.floating[k]||r.floating[I]);let ut=E/2-$/2,mt=rt/2-L[I]/2-1,ot=Wt(u[y],mt),io=Wt(u[W],mt),ro=rt-L[I]-io,It=rt/2-L[I]/2+ut,lt=ga(ot,It,ro),xt=!n.arrow&&wo(i)!=null&&It!==lt&&r.reference[I]/2-(It<ot?ot:io)-L[I]/2<0,Lt=xt?It<ot?It-ot:It-ro:0;return{[C]:m[C]+Lt,data:{[C]:lt,centerOffset:It-lt-Lt,...xt&&{alignmentOffset:Lt}},reset:xt}}});var Hi=function(t){return t===void 0&&(t={}),{name:"flip",options:t,async fn(o){var e,a;let{placement:i,middlewareData:r,rects:l,initialPlacement:s,platform:n,elements:g}=o,{mainAxis:h=!0,crossAxis:u=!0,fallbackPlacements:m,fallbackStrategy:C="bestFit",fallbackAxisSideDirection:I="none",flipAlignment:L=!0,...v}=po(t,o);if((e=r.arrow)!=null&&e.alignmentOffset)return{};let y=oo(i),W=Yt(s),k=oo(s)===s,E=await(n.isRTL==null?void 0:n.isRTL(g.floating)),$=m||(k||!L?[_o(s)]:zi(s)),V=I!=="none";!m&&V&&$.push(...Vi(s,L,I,E));let rt=[s,...$],ut=await n.detectOverflow(o,v),mt=[],ot=((a=r.flip)==null?void 0:a.overflows)||[];if(h&&mt.push(ut[y]),u){let lt=Di(i,l,E);mt.push(ut[lt[0]],ut[lt[1]])}if(ot=[...ot,{placement:i,overflows:mt}],!mt.every(lt=>lt<=0)){var io,ro;let lt=(((io=r.flip)==null?void 0:io.index)||0)+1,xt=rt[lt];if(xt&&(!(u==="alignment"?W!==Yt(xt):!1)||ot.every(Ct=>Yt(Ct.placement)===W?Ct.overflows[0]>0:!0)))return{data:{index:lt,overflows:ot},reset:{placement:xt}};let Lt=(ro=ot.filter(et=>et.overflows[0]<=0).sort((et,Ct)=>et.overflows[1]-Ct.overflows[1])[0])==null?void 0:ro.placement;if(!Lt)switch(C){case"bestFit":{var It;let et=(It=ot.filter(Ct=>{if(V){let Qt=Yt(Ct.placement);return Qt===W||Qt==="y"}return!0}).map(Ct=>[Ct.placement,Ct.overflows.filter(Qt=>Qt>0).reduce((Qt,Oo)=>Qt+Oo,0)]).sort((Ct,Qt)=>Ct[1]-Qt[1])[0])==null?void 0:It[0];et&&(Lt=et);break}case"initialPlacement":Lt=s;break}if(i!==Lt)return{reset:{placement:Lt}}}return{}}}};var Yl=new Set(["left","top"]);async function Nl(t,o){let{placement:e,platform:a,elements:i}=t,r=await(a.isRTL==null?void 0:a.isRTL(i.floating)),l=oo(e),s=wo(e),n=Yt(e)==="y",g=Yl.has(l)?-1:1,h=r&&n?-1:1,u=po(o,t),{mainAxis:m,crossAxis:C,alignmentAxis:I}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return s&&typeof I=="number"&&(C=s==="end"?I*-1:I),n?{x:C*h,y:m*g}:{x:m*g,y:C*h}}var Ki=function(t){return t===void 0&&(t=0),{name:"offset",options:t,async fn(o){var e,a;let{x:i,y:r,placement:l,middlewareData:s}=o,n=await Nl(o,t);return l===((e=s.offset)==null?void 0:e.placement)&&(a=s.arrow)!=null&&a.alignmentOffset?{}:{x:i+n.x,y:r+n.y,data:{...n,placement:l}}}}},qi=function(t){return t===void 0&&(t={}),{name:"shift",options:t,async fn(o){let{x:e,y:a,placement:i,platform:r}=o,{mainAxis:l=!0,crossAxis:s=!1,limiter:n={fn:W=>{let{x:k,y:E}=W;return{x:k,y:E}}},...g}=po(t,o),h={x:e,y:a},u=await r.detectOverflow(o,g),m=Yt(i),C=ba(m),I=h[C],L=h[m],v=(W,k)=>ga(k+u[W==="y"?"top":"left"],k,k-u[W==="y"?"bottom":"right"]);l&&(I=v(C,I)),s&&(L=v(m,L));let y=n.fn({...o,[C]:I,[m]:L});return{...y,data:{x:y.x-e,y:y.y-a,enabled:{[C]:l,[m]:s}}}}}};var $i=function(t){return t===void 0&&(t={}),{name:"size",options:t,async fn(o){let{placement:e,rects:a,platform:i,elements:r}=o,{apply:l=()=>{},...s}=po(t,o),n=await i.detectOverflow(o,s),g=oo(e),h=wo(e),u=Yt(e)==="y",{width:m,height:C}=a.floating,I,L;g==="top"||g==="bottom"?(I=g,L=h===(await(i.isRTL==null?void 0:i.isRTL(r.floating))?"start":"end")?"left":"right"):(L=g,I=h==="end"?"top":"bottom");let v=C-n.top-n.bottom,y=m-n.left-n.right,W=Wt(C-n[I],v),k=Wt(m-n[L],y),E=o.middlewareData.shift,$=!E,V=W,rt=k;E!=null&&E.enabled.x&&(rt=y),E!=null&&E.enabled.y&&(V=v),$&&!h&&(u?rt=m-2*Xt(n.left,n.right):V=C-2*Xt(n.top,n.bottom)),await l({...o,availableWidth:rt,availableHeight:V});let ut=await i.getDimensions(r.floating);return m!==ut.width||C!==ut.height?{reset:{rects:!0}}:{}}}};function Ze(){return typeof window<"u"}function vo(t){return Pi(t)?(t.nodeName||"").toLowerCase():"#document"}function gt(t){var o;return(t==null||(o=t.ownerDocument)==null?void 0:o.defaultView)||window}function Nt(t){var o;return(o=(Pi(t)?t.ownerDocument:t.document)||window.document)==null?void 0:o.documentElement}function Pi(t){return Ze()?t instanceof Node||t instanceof gt(t).Node:!1}function At(t){return Ze()?t instanceof Element||t instanceof gt(t).Element:!1}function Vt(t){return Ze()?t instanceof HTMLElement||t instanceof gt(t).HTMLElement:!1}function _i(t){return!Ze()||typeof ShadowRoot>"u"?!1:t instanceof ShadowRoot||t instanceof gt(t).ShadowRoot}function oe(t){let{overflow:o,overflowX:e,overflowY:a,display:i}=Gt(t);return/auto|scroll|overlay|hidden|clip/.test(o+a+e)&&i!=="inline"&&i!=="contents"}function tr(t){return/^(table|td|th)$/.test(vo(t))}function ee(t){try{if(t.matches(":popover-open"))return!0}catch{}try{return t.matches(":modal")}catch{return!1}}var Sl=/transform|translate|scale|rotate|perspective|filter/,Ol=/paint|layout|strict|content/,Qo=t=>!!t&&t!=="none",ua;function xo(t){let o=At(t)?Gt(t):t;return Qo(o.transform)||Qo(o.translate)||Qo(o.scale)||Qo(o.rotate)||Qo(o.perspective)||!Ye()&&(Qo(o.backdropFilter)||Qo(o.filter))||Sl.test(o.willChange||"")||Ol.test(o.contain||"")}function or(t){let o=eo(t);for(;Vt(o)&&!Wo(o);){if(xo(o))return o;if(ee(o))return null;o=eo(o)}return null}function Ye(){return ua==null&&(ua=typeof CSS<"u"&&CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")),ua}function Wo(t){return/^(html|body|#document)$/.test(vo(t))}function Gt(t){return gt(t).getComputedStyle(t)}function ae(t){return At(t)?{scrollLeft:t.scrollLeft,scrollTop:t.scrollTop}:{scrollLeft:t.scrollX,scrollTop:t.scrollY}}function eo(t){if(vo(t)==="html")return t;let o=t.assignedSlot||t.parentNode||_i(t)&&t.host||Nt(t);return _i(o)?o.host:o}function er(t){let o=eo(t);return Wo(o)?(t.ownerDocument||t).body:Vt(o)&&oe(o)?o:er(o)}function zt(t,o,e){var a;o===void 0&&(o=[]),e===void 0&&(e=!0);let i=er(t),r=i===((a=t.ownerDocument)==null?void 0:a.body),l=gt(i);if(r){let s=Ne(l);return o.concat(l,l.visualViewport||[],oe(i)?i:[],s&&e?zt(s):[])}else return o.concat(i,zt(i,[],e))}function Ne(t){return t.parent&&Object.getPrototypeOf(t.parent)?t.frameElement:null}function rr(t){let o=Gt(t),e=parseFloat(o.width)||0,a=parseFloat(o.height)||0,i=Vt(t),r=i?t.offsetWidth:e,l=i?t.offsetHeight:a,s=Po(e)!==r||Po(a)!==l;return s&&(e=r,a=l),{width:e,height:a,$:s}}function Ia(t){return At(t)?t:t.contextElement}function Zo(t){let o=Ia(t);if(!Vt(o))return Zt(1);let e=o.getBoundingClientRect(),{width:a,height:i,$:r}=rr(o),l=(r?Po(e.width):e.width)/a,s=(r?Po(e.height):e.height)/i;return(!l||!Number.isFinite(l))&&(l=1),(!s||!Number.isFinite(s))&&(s=1),{x:l,y:s}}var kl=Zt(0);function lr(t){let o=gt(t);return!Ye()||!o.visualViewport?kl:{x:o.visualViewport.offsetLeft,y:o.visualViewport.offsetTop}}function Rl(t,o,e){return o===void 0&&(o=!1),!!e&&o&&e===gt(t)}function yo(t,o,e,a){o===void 0&&(o=!1),e===void 0&&(e=!1);let i=t.getBoundingClientRect(),r=Ia(t),l=Zt(1);o&&(a?At(a)&&(l=Zo(a)):l=Zo(t));let s=Rl(r,e,a)?lr(r):Zt(0),n=(i.left+s.x)/l.x,g=(i.top+s.y)/l.y,h=i.width/l.x,u=i.height/l.y;if(r&&a){let m=gt(r),C=At(a)?gt(a):a,I=m,L=Ne(I);for(;L&&C!==I;){let v=Zo(L),y=L.getBoundingClientRect(),W=Gt(L),k=y.left+(L.clientLeft+parseFloat(W.paddingLeft))*v.x,E=y.top+(L.clientTop+parseFloat(W.paddingTop))*v.y;n*=v.x,g*=v.y,h*=v.x,u*=v.y,n+=k,g+=E,I=gt(L),L=Ne(I)}}return Lo({width:h,height:u,x:n,y:g})}function Se(t,o){let e=ae(t).scrollLeft;return o?o.left+e:yo(Nt(t)).left+e}function cr(t,o){let e=t.getBoundingClientRect(),a=e.left+o.scrollLeft-Se(t,e),i=e.top+o.scrollTop;return{x:a,y:i}}function El(t){let{elements:o,rect:e,offsetParent:a,strategy:i}=t,r=i==="fixed",l=Nt(a),s=o?ee(o.floating):!1;if(a===l||s&&r)return e;let n={scrollLeft:0,scrollTop:0},g=Zt(1),h=Zt(0),u=Vt(a);if((u||!r)&&((vo(a)!=="body"||oe(l))&&(n=ae(a)),u)){let C=yo(a);g=Zo(a),h.x=C.x+a.clientLeft,h.y=C.y+a.clientTop}let m=l&&!u&&!r?cr(l,n):Zt(0);return{width:e.width*g.x,height:e.height*g.y,x:e.x*g.x-n.scrollLeft*g.x+h.x+m.x,y:e.y*g.y-n.scrollTop*g.y+h.y+m.y}}function Dl(t){return t.getClientRects?Array.from(t.getClientRects()):[]}function zl(t){let o=ae(t),e=t.ownerDocument.body,a=Xt(t.scrollWidth,t.clientWidth,e.scrollWidth,e.clientWidth),i=Xt(t.scrollHeight,t.clientHeight,e.scrollHeight,e.clientHeight),r=-o.scrollLeft+Se(t),l=-o.scrollTop;return Gt(e).direction==="rtl"&&(r+=Xt(t.clientWidth,e.clientWidth)-a),{width:a,height:i,x:r,y:l}}var Vl=25;function Ml(t,o,e){e===void 0&&(e="viewport");let a=e==="layoutViewport",i=gt(t),r=Nt(t),l=i.visualViewport,s=r.clientWidth,n=r.clientHeight,g=0,h=0;if(l){let m=!Ye()||o==="fixed";a?m||(g=-l.offsetLeft,h=-l.offsetTop):(s=l.width,n=l.height,m&&(g=l.offsetLeft,h=l.offsetTop))}if(Se(r)<=0){let m=r.ownerDocument,C=m.body,I=getComputedStyle(C),L=m.compatMode==="CSS1Compat"&&parseFloat(I.marginLeft)+parseFloat(I.marginRight)||0,v=Math.abs(r.clientWidth-C.clientWidth-L),y=getComputedStyle(r).scrollbarGutter==="stable both-edges"?v/2:v;y<=Vl&&(s-=y)}return{width:s,height:n,x:g,y:h}}function Jl(t,o){let e=yo(t,!0,o==="fixed"),a=e.top+t.clientTop,i=e.left+t.clientLeft,r=Zo(t),l=t.clientWidth*r.x,s=t.clientHeight*r.y,n=i*r.x,g=a*r.y;return{width:l,height:s,x:n,y:g}}function ar(t,o,e){let a;if(o==="viewport"||o==="layoutViewport")a=Ml(t,e,o);else if(o==="document")a=zl(Nt(t));else if(At(o))a=Jl(o,e);else{let i=lr(t);a={x:o.x-i.x,y:o.y-i.y,width:o.width,height:o.height}}return Lo(a)}function jl(t,o){let e=o.get(t);if(e)return e;let a=zt(t,[],!1).filter(s=>At(s)&&vo(s)!=="body"),i=null,r=Gt(t).position==="fixed",l=r?eo(t):t;for(;At(l)&&!Wo(l);){let s=Gt(l),n=xo(l),g=i?i.position:r?"fixed":"";!n&&(g==="fixed"||g==="absolute"&&s.position==="static")?a=a.filter(u=>u!==l):i=s,l=eo(l)}return o.set(t,a),a}function Tl(t){let{element:o,boundary:e,rootBoundary:a,strategy:i}=t,l=[...e==="clippingAncestors"?ee(o)?[]:jl(o,this._c):[].concat(e),a],s=ar(o,l[0],i),n=s.top,g=s.right,h=s.bottom,u=s.left;for(let m=1;m<l.length;m++){let C=ar(o,l[m],i);n=Xt(C.top,n),g=Wt(C.right,g),h=Wt(C.bottom,h),u=Xt(C.left,u)}return{width:g-u,height:h-n,x:u,y:n}}function Hl(t){let{width:o,height:e}=rr(t);return{width:o,height:e}}function Kl(t,o,e){let a=Vt(o),i=Nt(o),r=e==="fixed",l=yo(t,!0,r,o),s={scrollLeft:0,scrollTop:0},n=Zt(0);if((a||!r)&&((vo(o)!=="body"||oe(i))&&(s=ae(o)),a)){let m=yo(o,!0,r,o);n.x=m.x+o.clientLeft,n.y=m.y+o.clientTop}!a&&i&&(n.x=Se(i));let g=i&&!a&&!r?cr(i,s):Zt(0),h=l.left+s.scrollLeft-n.x-g.x,u=l.top+s.scrollTop-n.y-g.y;return{x:h,y:u,width:l.width,height:l.height}}function ma(t){return Gt(t).position==="static"}function ir(t,o){if(!Vt(t)||Gt(t).position==="fixed")return null;if(o)return o(t);let e=t.offsetParent;return Nt(t)===e&&(e=e.ownerDocument.body),e}function nr(t,o){let e=gt(t);if(ee(t))return e;if(!Vt(t)){let i=eo(t);for(;i&&!Wo(i);){if(At(i)&&!ma(i))return i;i=eo(i)}return e}let a=ir(t,o);for(;a&&tr(a)&&ma(a);)a=ir(a,o);return a&&Wo(a)&&ma(a)&&!xo(a)?e:a||or(t)||e}var ql=async function(t){let o=this.getOffsetParent||nr,e=this.getDimensions,a=await e(t.floating);return{reference:Kl(t.reference,await o(t.floating),t.strategy),floating:{x:0,y:0,width:a.width,height:a.height}}};function $l(t){return Gt(t).direction==="rtl"}var ie={convertOffsetParentRelativeRectToViewportRelativeRect:El,getDocumentElement:Nt,getClippingRect:Tl,getOffsetParent:nr,getElementRects:ql,getClientRects:Dl,getDimensions:Hl,getScale:Zo,isElement:At,isRTL:$l};function sr(t,o){return t.x===o.x&&t.y===o.y&&t.width===o.width&&t.height===o.height}function _l(t,o,e){let a=null,i,r=Nt(t);function l(){var h;clearTimeout(i),(h=a)==null||h.disconnect(),a=null}function s(h,u){h===void 0&&(h=!1),u===void 0&&(u=1),l();let m=t.getBoundingClientRect(),{left:C,top:I,width:L,height:v}=m;if(h||o(),!L||!v)return;let y=te(I),W=te(r.clientWidth-(C+L)),k=te(r.clientHeight-(I+v)),E=te(C),V={rootMargin:-y+"px "+-W+"px "+-k+"px "+-E+"px",threshold:Xt(0,Wt(1,u))||1},rt=!0;function ut(mt){let ot=mt[0].intersectionRatio;if(!sr(m,t.getBoundingClientRect()))return s();if(ot!==u){if(!rt)return s();ot?s(!1,ot):i=setTimeout(()=>{s(!1,1e-7)},1e3)}rt=!1}try{a=new IntersectionObserver(ut,{...V,root:r.ownerDocument})}catch{a=new IntersectionObserver(ut,V)}a.observe(t)}let n=gt(t),g=()=>s(e);return n.addEventListener("resize",g),s(!0),()=>{n.removeEventListener("resize",g),l()}}function dr(t,o,e,a){a===void 0&&(a={});let{ancestorScroll:i=!0,ancestorResize:r=!0,elementResize:l=typeof ResizeObserver=="function",layoutShift:s=typeof IntersectionObserver=="function",animationFrame:n=!1}=a,g=Ia(t),h=i||r?[...g?zt(g):[],...o?zt(o):[]]:[];h.forEach(y=>{i&&y.addEventListener("scroll",e),r&&y.addEventListener("resize",e)});let u=g&&s?_l(g,e,r):null,m=-1,C=null;l&&(C=new ResizeObserver(y=>{let[W]=y;W&&W.target===g&&C&&o&&(C.unobserve(o),cancelAnimationFrame(m),m=requestAnimationFrame(()=>{var k;(k=C)==null||k.observe(o)})),e()}),g&&!n&&C.observe(g),o&&C.observe(o));let I,L=n?yo(t):null;n&&v();function v(){let y=yo(t);L&&!sr(L,y)&&e(),L=y,I=requestAnimationFrame(v)}return e(),()=>{var y;h.forEach(W=>{i&&W.removeEventListener("scroll",e),r&&W.removeEventListener("resize",e)}),u?.(),(y=C)==null||y.disconnect(),C=null,n&&cancelAnimationFrame(I)}}var gr=Ki;var br=qi,hr=Hi,Ca=$i;var ur=Ti;var mr=(t,o,e)=>{let a=new Map,i=e??{},r={...ie,...i.platform,_c:a};return ji(t,o,{...i,platform:r})};function Ir(t){return Pl(t)}function pa(t){return t.assignedSlot?t.assignedSlot:t.parentNode instanceof ShadowRoot?t.parentNode.host:t.parentNode}function Pl(t){for(let o=t;o;o=pa(o))if(o instanceof Element&&getComputedStyle(o).display==="none")return null;for(let o=pa(t);o;o=pa(o)){if(!(o instanceof Element))continue;let e=getComputedStyle(o);if(e.display!=="contents"&&(e.position!=="static"||xo(e)||o.tagName==="BODY"))return o}return null}function Cr(t){return t!==null&&typeof t=="object"&&"getBoundingClientRect"in t&&("contextElement"in t?t instanceof Element:!0)}var tc=!!globalThis?.HTMLElement?.prototype.hasOwnProperty("popover"),S=class extends K{constructor(){super(...arguments),this.localize=new bt(this),this.SUPPORTS_POPOVER=!1,this.active=!1,this.placement="top",this.boundary="viewport",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl&&this.popup){let t=this.anchorEl.getBoundingClientRect(),o=this.popup.getBoundingClientRect(),e=this.placement.includes("top")||this.placement.includes("bottom"),a=0,i=0,r=0,l=0,s=0,n=0,g=0,h=0;e?t.top<o.top?(a=t.left,i=t.bottom,r=t.right,l=t.bottom,s=o.left,n=o.top,g=o.right,h=o.top):(a=o.left,i=o.bottom,r=o.right,l=o.bottom,s=t.left,n=t.top,g=t.right,h=t.top):t.left<o.left?(a=t.right,i=t.top,r=o.left,l=o.top,s=t.right,n=t.bottom,g=o.left,h=o.bottom):(a=o.right,i=o.top,r=t.left,l=t.top,s=o.right,n=o.bottom,g=t.left,h=t.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${a}px`),this.style.setProperty("--hover-bridge-top-left-y",`${i}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${s}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${g}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${h}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.SUPPORTS_POPOVER=tc,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(t){super.updated(t),t.has("active")&&(this.active?this.start():this.stop()),t.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){let t=this.getRootNode();this.anchorEl=t.getElementById(this.anchor)}else this.anchor instanceof Element||Cr(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){!this.anchorEl||!this.active||!this.isConnected||(this.popup?.showPopover?.(),this.cleanup=dr(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(t=>{this.popup?.hidePopover?.(),this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>t())):t()})}reposition(){if(!this.active||!this.anchorEl||!this.popup)return;let t=[gr({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?t.push(Ca({apply:({rects:a})=>{let i=this.sync==="width"||this.sync==="both",r=this.sync==="height"||this.sync==="both";this.popup.style.width=i?`${a.reference.width}px`:"",this.popup.style.height=r?`${a.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height="");let o;this.SUPPORTS_POPOVER&&!Cr(this.anchor)&&this.boundary==="scroll"&&(o=zt(this.anchorEl).filter(a=>a instanceof Element)),this.flip&&t.push(hr({boundary:this.flipBoundary||o,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&t.push(br({boundary:this.shiftBoundary||o,padding:this.shiftPadding})),this.autoSize?t.push(Ca({boundary:this.autoSizeBoundary||o,padding:this.autoSizePadding,apply:({availableWidth:a,availableHeight:i})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${i}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${a}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&t.push(ur({element:this.arrowEl,padding:this.arrowPadding}));let e=this.SUPPORTS_POPOVER?a=>ie.getOffsetParent(a,Ir):ie.getOffsetParent;mr(this.anchorEl,this.popup,{placement:this.placement,middleware:t,strategy:this.SUPPORTS_POPOVER?"absolute":"fixed",platform:{...ie,getOffsetParent:e}}).then(({x:a,y:i,middlewareData:r,placement:l})=>{let s=this.localize.dir()==="rtl",n={top:"bottom",right:"left",bottom:"top",left:"right"}[l.split("-")[0]];if(this.setAttribute("data-current-placement",l),Object.assign(this.popup.style,{left:`${a}px`,top:`${i}px`}),this.arrow){let g=r.arrow.x,h=r.arrow.y,u="",m="",C="",I="";if(this.arrowPlacement==="start"){let L=typeof g=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";u=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",m=s?L:"",I=s?"":L}else if(this.arrowPlacement==="end"){let L=typeof g=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";m=s?"":L,I=s?L:"",C=typeof h=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(I=typeof g=="number"?"calc(50% - var(--arrow-size-diagonal))":"",u=typeof h=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(I=typeof g=="number"?`${g}px`:"",u=typeof h=="number"?`${h}px`:"");Object.assign(this.arrowEl.style,{top:u,right:m,bottom:C,left:I,[n]:"calc(var(--arrow-base-offset) - var(--arrow-size-diagonal))"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.dispatchEvent(new Oi)}render(){return A`
    ...
    `}};S.css=ki;c([N(".popup")],S.prototype,"popup",2);c([N(".arrow")],S.prototype,"arrowEl",2);c([d({attribute:!1,type:Boolean})],S.prototype,"SUPPORTS_POPOVER",2);c([d()],S.prototype,"anchor",2);c([d({type:Boolean,reflect:!0})],S.prototype,"active",2);c([d({reflect:!0})],S.prototype,"placement",2);c([d()],S.prototype,"boundary",2);c([d({type:Number})],S.prototype,"distance",2);c([d({type:Number})],S.prototype,"skidding",2);c([d({type:Boolean})],S.prototype,"arrow",2);c([d({attribute:"arrow-placement"})],S.prototype,"arrowPlacement",2);c([d({attribute:"arrow-padding",type:Number})],S.prototype,"arrowPadding",2);c([d({type:Boolean})],S.prototype,"flip",2);c([d({attribute:"flip-fallback-placements",converter:{fromAttribute:t=>t.split(" ").map(o=>o.trim()).filter(o=>o!==""),toAttribute:t=>t.join(" ")}})],S.prototype,"flipFallbackPlacements",2);c([d({attribute:"flip-fallback-strategy"})],S.prototype,"flipFallbackStrategy",2);c([d({type:Object})],S.prototype,"flipBoundary",2);c([d({attribute:"flip-padding",type:Number})],S.prototype,"flipPadding",2);c([d({type:Boolean})],S.prototype,"shift",2);c([d({type:Object})],S.prototype,"shiftBoundary",2);c([d({attribute:"shift-padding",type:Number})],S.prototype,"shiftPadding",2);c([d({attribute:"auto-size"})],S.prototype,"autoSize",2);c([d()],S.prototype,"sync",2);c([d({type:Object})],S.prototype,"autoSizeBoundary",2);c([d({attribute:"auto-size-padding",type:Number})],S.prototype,"autoSizePadding",2);c([d({attribute:"hover-bridge",type:Boolean})],S.prototype,"hoverBridge",2);S=c([j("wa-popup")],S);var pr=U`
  @layer wa-component {
    :host {
      display: inline-block;
...
`;var Lr=Symbol.for(""),oc=t=>{if(t?.r===Lr)return t?._$litStatic$};var wa=(t,...o)=>({_$litStatic$:o.reduce((e,a,i)=>e+(r=>{if(r._$litStatic$!==void 0)return r._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${r}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(a)+t[i+1],t[0]),r:Lr}),wr=new Map,La=t=>(o,...e)=>{let a=e.length,i,r,l=[],s=[],n,g=0,h=!1;for(;g<a;){for(n=o[g];g<a&&(r=e[g],(i=oc(r))!==void 0);)n+=i+o[++g],h=!0;g!==a&&s.push(r),l.push(n),g++}if(g===a&&l.push(o[a]),h){let u=l.join("$$lit$$");(o=wr.get(u))===void 0&&(l.raw=l,wr.set(u,o=l)),e=s}return t(o,...e)},Oe=La(A),tb=La(_a),ob=La(Pa);var G=class extends st{constructor(){super(...arguments),this.assumeInteractionOn=["click"],this.hasSlotController=new $t(this,"[default]","start","end"),this.localize=new bt(this),this.invalid=!1,this.isIconButton=!1,this.title="",this.variant="neutral",this.appearance="accent",this.size="m",this.withCaret=!1,this.withStart=!1,this.withEnd=!1,this.disabled=!1,this.loading=!1,this.pill=!1,this.type="button"}static get validators(){return[...super.validators,Ge()]}handleSizeChange(){Tt(this.localName,this.size)}constructLightDOMButton(){let t=document.createElement("button");for(let o of this.attributes)o.name!=="style"&&t.setAttribute(o.name,o.value);return t.type=this.type,t.style.position="absolute !important",t.style.width="0 !important",t.style.height="0 !important",t.style.clipPath="inset(50%) !important",t.style.overflow="hidden !important",t.style.whiteSpace="nowrap !important",this.name&&(t.name=this.name),t.value=this.value||"",t}handleClick(t){if(this.disabled||this.loading){t.preventDefault(),t.stopImmediatePropagation();return}if(this.type!=="submit"&&this.type!=="reset"||!this.getForm())return;let e=this.constructLightDOMButton();this.parentElement?.append(e),e.click(),e.remove()}handleInvalid(){this.dispatchEvent(new Xo)}handleLabelSlotChange(){let t=this.labelSlot.assignedNodes({flatten:!0}),o=!1,e=!1,a=!1,i=!1;[...t].forEach(r=>{if(r.nodeType===Node.ELEMENT_NODE){let l=r;l.localName==="wa-icon"?(e=!0,o||(o=l.label!==void 0)):i=!0}else r.nodeType===Node.TEXT_NODE&&(r.textContent?.trim()||"").length>0&&(a=!0)}),this.isIconButton=e&&!a&&!i,this.customStates.set("icon-button",this.isIconButton),this.isIconButton&&!o&&console.warn('Icon buttons must have a label for screen readers. Add <wa-icon label="..."> to remove this warning.',this)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.customStates.set("disabled",this.disabled),this.updateValidity()}handleHrefChange(){this.customStates.set("link",this.isLink())}handleLoadingChange(){this.customStates.set("loading",this.loading)}setValue(...t){}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){let t=this.isLink(),o=t?wa`a`:wa`button`;return Oe`
      <${o}
        part="base"
    ...
    `}};G.shadowRootOptions={...st.shadowRootOptions,delegatesFocus:!0};G.css=[pr,Le,Ht];c([N(".button")],G.prototype,"button",2);c([N("slot:not([name])")],G.prototype,"labelSlot",2);c([R()],G.prototype,"invalid",2);c([R()],G.prototype,"isIconButton",2);c([d()],G.prototype,"title",2);c([d({reflect:!0})],G.prototype,"variant",2);c([d({reflect:!0})],G.prototype,"appearance",2);c([d({reflect:!0})],G.prototype,"size",2);c([x("size")],G.prototype,"handleSizeChange",1);c([d({attribute:"with-caret",type:Boolean,reflect:!0})],G.prototype,"withCaret",2);c([d({attribute:"with-start",type:Boolean})],G.prototype,"withStart",2);c([d({attribute:"with-end",type:Boolean})],G.prototype,"withEnd",2);c([d({type:Boolean})],G.prototype,"disabled",2);c([d({type:Boolean,reflect:!0})],G.prototype,"loading",2);c([d({type:Boolean,reflect:!0})],G.prototype,"pill",2);c([d()],G.prototype,"type",2);c([d({reflect:!0})],G.prototype,"name",2);c([d({reflect:!0})],G.prototype,"value",2);c([d({reflect:!0})],G.prototype,"href",2);c([d()],G.prototype,"target",2);c([d()],G.prototype,"rel",2);c([d()],G.prototype,"download",2);c([d({attribute:"formaction"})],G.prototype,"formAction",2);c([d({attribute:"formenctype"})],G.prototype,"formEnctype",2);c([d({attribute:"formmethod"})],G.prototype,"formMethod",2);c([d({attribute:"formnovalidate",type:Boolean})],G.prototype,"formNoValidate",2);c([d({attribute:"formtarget"})],G.prototype,"formTarget",2);c([x("disabled",{waitUntilFirstUpdate:!0})],G.prototype,"handleDisabledChange",1);c([x("href")],G.prototype,"handleHrefChange",1);c([x("loading",{waitUntilFirstUpdate:!0})],G.prototype,"handleLoadingChange",1);G=c([j("wa-button")],G);G.disableWarning?.("change-in-update");var Qr=U`
  :host {
    --track-width: 2px;
...
`;var Qa=class extends K{constructor(){super(...arguments),this.localize=new bt(this)}render(){return A`
      <svg
        part="base"
        role="progressbar"
    ...
    `}};Qa.css=Qr;Qa=c([j("wa-spinner")],Qa);var vr=U`
  :host {
    display: inline-flex;
  }
...
`;var ao=class extends K{constructor(){super(...arguments),this.disableRole=!1,this.hasOutlined=!1,this.label="",this.orientation="horizontal"}updated(t){super.updated(t),t.has("orientation")&&this.setAttribute("aria-orientation",this.orientation)}handleFocus(t){ke(t.target)?.classList.add("button-focus")}handleBlur(t){ke(t.target)?.classList.remove("button-focus")}handleMouseOver(t){ke(t.target)?.classList.add("button-hover")}handleMouseOut(t){ke(t.target)?.classList.remove("button-hover")}render(){return A`
      ...
      ></slot>
    `}};ao.css=[vr];c([N("slot")],ao.prototype,"defaultSlot",2);c([R()],ao.prototype,"disableRole",2);c([R()],ao.prototype,"hasOutlined",2);c([d()],ao.prototype,"label",2);c([d({reflect:!0})],ao.prototype,"orientation",2);ao=c([j("wa-button-group")],ao);function ke(t){let o="wa-button, wa-radio-button";return t.closest(o)??t.querySelector(o)}var Yo=class extends Event{constructor(){super("wa-error",{bubbles:!0,cancelable:!1,composed:!0})}};var yr=class extends Event{constructor(){super("wa-load",{bubbles:!0,cancelable:!1,composed:!0})}};var Br=U`
  :host {
...
`;var De=class extends Event{constructor(){super("wa-show",{bubbles:!0,cancelable:!0,composed:!0})}};var ze=class extends Event{constructor(t){super("wa-hide",{bubbles:!0,cancelable:!0,composed:!0}),this.detail=t}};var Ve=class extends Event{constructor(){super("wa-after-show",{bubbles:!0,cancelable:!1,composed:!0})}};var Me=class extends Event{constructor(){super("wa-after-hide",{bubbles:!0,cancelable:!1,composed:!0})}};var T=class extends K{constructor(){super(...arguments),this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.showDelay=150,this.hideDelay=0,this.trigger="hover focus",this.withoutArrow=!1,this.for=null,this.anchor=null,this.eventController=new AbortController,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.open&&qt(this)&&(t.preventDefault(),t.stopPropagation(),this.hide())},this.handleMouseOver=()=>{this.hasTrigger("hover")&&(clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),this.showDelay))},this.handleMouseOut=t=>{if(this.hasTrigger("hover")){let o=t.relatedTarget,e=!!(o&&this.anchor?.contains(o)),a=!!(o&&this.contains(o));if(e||a)return;clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>{this.hide()},this.hideDelay)}}}connectedCallback(){super.connectedCallback(),typeof document<"u"&&(this.eventController.signal.aborted&&(this.eventController=new AbortController),this.addEventListener("mouseout",this.handleMouseOut),this.open&&(this.open=!1,this.updateComplete.then(()=>{this.open=!0})),this.id||(this.id=Fe("wa-tooltip-")),this.for&&this.anchor?(this.anchor=null,this.handleForChange()):this.for&&this.handleForChange())}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.handleDocumentKeyDown),Io(this),this.eventController.abort(),this.anchor&&this.removeFromAriaLabelledBy(this.anchor,this.id)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(t){return this.trigger.split(" ").includes(t)}addToAriaLabelledBy(t,o){let a=(t.getAttribute("aria-labelledby")||"").split(/\s+/).filter(Boolean);a.includes(o)||(a.push(o),t.setAttribute("aria-labelledby",a.join(" ")))}removeFromAriaLabelledBy(t,o){let i=(t.getAttribute("aria-labelledby")||"").split(/\s+/).filter(Boolean).filter(r=>r!==o);i.length>0?t.setAttribute("aria-labelledby",i.join(" ")):t.removeAttribute("aria-labelledby")}async handleOpenChange(){if(this.open){if(this.disabled)return;let t=new De;if(this.dispatchEvent(t),t.defaultPrevented){this.open=!1;return}document.addEventListener("keydown",this.handleDocumentKeyDown,{signal:this.eventController.signal}),fo(this),this.body.hidden=!1,this.popup.active=!0,await dt(this.popup.popup,"show-with-scale"),this.popup.reposition(),this.dispatchEvent(new Ve)}else{let t=new ze;if(this.dispatchEvent(t),t.defaultPrevented){this.open=!1;return}document.removeEventListener("keydown",this.handleDocumentKeyDown),Io(this),await dt(this.popup.popup,"hide-with-scale"),this.popup.active=!1,this.body.hidden=!0,this.dispatchEvent(new Me)}}handleForChange(){let t=this.getRootNode?.();if(!t)return;let o=this.for?t.getElementById?.(this.for):null,e=this.anchor;if(o===e)return;let{signal:a}=this.eventController;o&&(this.addToAriaLabelledBy(o,this.id),o.addEventListener("blur",this.handleBlur,{capture:!0,signal:a}),o.addEventListener("focus",this.handleFocus,{capture:!0,signal:a}),o.addEventListener("click",this.handleClick,{signal:a}),o.addEventListener("mouseover",this.handleMouseOver,{signal:a}),o.addEventListener("mouseout",this.handleMouseOut,{signal:a})),e&&(this.removeFromAriaLabelledBy(e,this.id),e.removeEventListener("blur",this.handleBlur,{capture:!0}),e.removeEventListener("focus",this.handleFocus,{capture:!0}),e.removeEventListener("click",this.handleClick),e.removeEventListener("mouseover",this.handleMouseOver),e.removeEventListener("mouseout",this.handleMouseOut)),this.anchor=o}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,Ao(this,"wa-after-show")}async hide(){if(this.open)return this.open=!1,Ao(this,"wa-after-hide")}render(){return A`
    ...
    `}};T.css=Or;T.dependencies={"wa-popup":S};c([N("slot:not([name])")],T.prototype,"defaultSlot",2);c([N(".body")],T.prototype,"body",2);c([N("wa-popup")],T.prototype,"popup",2);c([d()],T.prototype,"placement",2);c([d({type:Boolean,reflect:!0})],T.prototype,"disabled",2);c([d({type:Number})],T.prototype,"distance",2);c([d({type:Boolean,reflect:!0})],T.prototype,"open",2);c([d({type:Number})],T.prototype,"skidding",2);c([d({attribute:"show-delay",type:Number})],T.prototype,"showDelay",2);c([d({attribute:"hide-delay",type:Number})],T.prototype,"hideDelay",2);c([d()],T.prototype,"trigger",2);c([d({attribute:"without-arrow",type:Boolean,reflect:!0})],T.prototype,"withoutArrow",2);c([d()],T.prototype,"for",2);c([R()],T.prototype,"anchor",2);c([x("open",{waitUntilFirstUpdate:!0})],T.prototype,"handleOpenChange",1);c([x("for")],T.prototype,"handleForChange",1);c([x(["distance","placement","skidding"])],T.prototype,"handleOptionsChange",1);c([x("disabled")],T.prototype,"handleDisabledChange",1);T=c([j("wa-tooltip")],T);var Xa=new Set;function gc(){let t=document.documentElement.clientWidth;return Math.abs(window.innerWidth-t)}function bc(){let t=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(t)||!t?0:t}function Aa(t){if(Xa.add(t),!document.documentElement.classList.contains("wa-scroll-lock")){let o=gc()+bc(),e=getComputedStyle(document.documentElement).scrollbarGutter;(!e||e==="auto")&&(e="stable"),o<2&&(e=""),document.documentElement.style.setProperty("--wa-scroll-lock-gutter",e),document.documentElement.classList.add("wa-scroll-lock"),document.documentElement.style.setProperty("--wa-scroll-lock-size",`${o}px`)}}function Ga(t){Xa.delete(t),Xa.size===0&&(document.documentElement.classList.remove("wa-scroll-lock"),document.documentElement.style.removeProperty("--wa-scroll-lock-size"))}function kr(t){return t.split(" ").map(o=>o.trim()).filter(o=>o!=="")}var Rr=U`
  :host {
    --width: 31rem;
...
`;var Ut=class extends K{constructor(){super(...arguments),this.localize=new bt(this),this.hasSlotController=new $t(this,"footer","header-actions","label"),this.open=!1,this.label="",this.withoutHeader=!1,this.lightDismiss=!1,this.withFooter=!1,this.handleDocumentKeyDown=t=>{t.key==="Escape"&&this.open&&qt(this)&&(t.preventDefault(),t.stopPropagation(),this.requestClose(this.dialog))}}firstUpdated(){this.open&&(this.addOpenListeners(),this.dialog.showModal(),Aa(this))}disconnectedCallback(){super.disconnectedCallback(),Ga(this),this.removeOpenListeners()}async requestClose(t){let o=new ze({source:t});if(this.dispatchEvent(o),o.defaultPrevented){this.open=!0,dt(this.dialog,"pulse");return}this.removeOpenListeners(),await dt(this.dialog,"hide"),this.open=!1,this.dialog.close(),Ga(this);let e=this.originalTrigger;typeof e?.focus=="function"&&setTimeout(()=>e.focus()),this.dispatchEvent(new Me)}addOpenListeners(){document.addEventListener("keydown",this.handleDocumentKeyDown),fo(this)}removeOpenListeners(){document.removeEventListener("keydown",this.handleDocumentKeyDown),Io(this)}handleDialogCancel(t){t.preventDefault(),!this.dialog.classList.contains("hide")&&t.target===this.dialog&&qt(this)&&this.requestClose(this.dialog)}handleDialogClick(t){let e=t.target.closest('[data-dialog="close"]');e&&(t.stopPropagation(),this.requestClose(e))}async handleDialogPointerDown(t){t.target===this.dialog&&(this.lightDismiss?this.requestClose(this.dialog):await dt(this.dialog,"pulse"))}handleOpenChange(){this.open&&!this.dialog.open?this.show():!this.open&&this.dialog.open&&(this.open=!0,this.requestClose(this.dialog))}async show(){let t=new De;if(this.dispatchEvent(t),t.defaultPrevented){this.open=!1;return}this.addOpenListeners(),this.originalTrigger=document.activeElement,this.open=!0,this.dialog.showModal(),Aa(this),requestAnimationFrame(()=>{let o=this.querySelector("[autofocus]");o&&typeof o.focus=="function"?o.focus():this.dialog.focus()}),await dt(this.dialog,"show"),this.dispatchEvent(new Ve)}render(){let t=!this.withoutHeader,o=this.hasSlotController.test("footer","withFooter");return A`
      <dialog
        part="dialog"
    ...
    `}};Ut.css=Rr;c([N(".dialog")],Ut.prototype,"dialog",2);c([d({type:Boolean,reflect:!0})],Ut.prototype,"open",2);c([d({reflect:!0})],Ut.prototype,"label",2);c([d({attribute:"without-header",type:Boolean,reflect:!0})],Ut.prototype,"withoutHeader",2);c([d({attribute:"light-dismiss",type:Boolean})],Ut.prototype,"lightDismiss",2);c([d({attribute:"with-footer",type:Boolean})],Ut.prototype,"withFooter",2);c([x("open",{waitUntilFirstUpdate:!0})],Ut.prototype,"handleOpenChange",1);Ut=c([j("wa-dialog")],Ut);document.addEventListener("click",t=>{let o=t.target.closest("[data-dialog]");if(o instanceof Element){let[e,a]=kr(o.getAttribute("data-dialog")||"");if(e==="open"&&a?.length){let r=o.getRootNode().getElementById(a);r?.localName==="wa-dialog"?r.open=!0:console.warn(`A dialog with an ID of "${a}" could not be found in this document.`)}}}),document.addEventListener("pointerdown",()=>{});var Ua=typeof navigator<"u"?navigator.userAgent.toLowerCase().indexOf("firefox")>0:!1;function xa(t,o,e,a){t.addEventListener?t.addEventListener(o,e,a):t.attachEvent&&t.attachEvent(`on${o}`,e)}function le(t,o,e,a){t&&(t.removeEventListener?t.removeEventListener(o,e,a):t.detachEvent&&t.detachEvent(`on${o}`,e))}function zr(t,o){let e=o.slice(0,o.length-1),a=[];for(let i=0;i<e.length;i++)a.push(t[e[i].toLowerCase()]);return a}function Vr(t){typeof t!="string"&&(t=""),t=t.replace(/\s/g,"");let o=t.split(","),e=o.lastIndexOf("");for(;e>=0;)o[e-1]+=",",o.splice(e,1),e=o.lastIndexOf("");return o}function hc(t,o){let e=t.length>=o.length?t:o,a=t.length>=o.length?o:t,i=!0;for(let r=0;r<e.length;r++)a.indexOf(e[r])===-1&&(i=!1);return i}function Mr(t){let o=t.keyCode||t.which||t.charCode;return t.key&&/^[a-z]$/i.test(t.key)?t.key.toUpperCase().charCodeAt(0):(t.code&&/^Key[A-Z]$/.test(t.code)&&(o=t.code.charCodeAt(3)),o)}var se={backspace:8,"\u232B":8,tab:9,clear:12,enter:13,"\u21A9":13,return:13,esc:27,escape:27,space:32,left:37,up:38,right:39,down:40,arrowup:38,arrowdown:40,arrowleft:37,arrowright:39,del:46,delete:46,ins:45,insert:45,home:36,end:35,pageup:33,pagedown:34,capslock:20,num_0:96,num_1:97,num_2:98,num_3:99,num_4:100,num_5:101,num_6:102,num_7:103,num_8:104,num_9:105,num_multiply:106,num_add:107,num_enter:108,num_subtract:109,num_decimal:110,num_divide:111,"\u21EA":20,",":188,".":190,"/":191,"`":192,"-":Ua?173:189,"=":Ua?61:187,";":Ua?59:186,"'":222,"{":219,"}":221,"[":219,"]":221,"\\":220},Ft={"\u21E7":16,shift:16,"\u2325":18,alt:18,option:18,"\u2303":17,ctrl:17,control:17,"\u2318":91,cmd:91,meta:91,command:91},ce={16:"shiftKey",18:"altKey",17:"ctrlKey",91:"metaKey",shiftKey:16,ctrlKey:17,altKey:18,metaKey:91},tt={16:!1,18:!1,17:!1,91:!1},M={};for(let t=1;t<20;t++)se[`f${t}`]=111+t;var z=[],ne=null,No=null,Jr="all",Mt=new Map,So=t=>se[t.toLowerCase()]||Ft[t.toLowerCase()]||t.toUpperCase().charCodeAt(0),uc=t=>Object.keys(se).find(o=>se[o]===t),mc=t=>Object.keys(Ft).find(o=>Ft[o]===t),jr=t=>{Jr=t||"all"},de=()=>Jr||"all",Ic=()=>z.slice(0),Cc=()=>z.map(t=>uc(t)||mc(t)||String.fromCharCode(t)),pc=()=>{let t=[];return Object.keys(M).forEach(o=>{M[o].forEach(({key:e,scope:a,mods:i,shortcut:r})=>{t.push({scope:a,shortcut:r,mods:i,keys:e.split("+").map(l=>So(l))})})}),t},Tr=t=>{let o=t.target||t.srcElement,{tagName:e}=o,a=!0,i=e==="INPUT"&&!["checkbox","radio","range","button","file","reset","submit","color"].includes(o.type);return(o.isContentEditable||(i||e==="TEXTAREA"||e==="SELECT")&&!o.readOnly)&&(a=!1),a},wc=t=>(typeof t=="string"&&(t=So(t)),z.indexOf(t)!==-1),Lc=(t,o)=>{let e,a;t||(t=de());for(let i in M)if(Object.prototype.hasOwnProperty.call(M,i))for(e=M[i],a=0;a<e.length;)e[a].scope===t?e.splice(a,1).forEach(({element:l})=>Za(l)):a++;de()===t&&jr(o||"all")};function Qc(t){let o=Mr(t);t.key&&t.key.toLowerCase()==="capslock"&&(o=So(t.key));let e=z.indexOf(o);if(e>=0&&z.splice(e,1),t.key&&t.key.toLowerCase()==="meta"&&z.splice(0,z.length),(o===93||o===224)&&(o=91),o in tt){tt[o]=!1;for(let a in Ft)Ft[a]===o&&(St[a]=!1)}}var Hr=(t,...o)=>{if(typeof t>"u")Object.keys(M).forEach(e=>{Array.isArray(M[e])&&M[e].forEach(a=>Je(a)),delete M[e]}),Za(null);else if(Array.isArray(t))t.forEach(e=>{e.key&&Je(e)});else if(typeof t=="object")t.key&&Je(t);else if(typeof t=="string"){let[e,a]=o;typeof e=="function"&&(a=e,e=""),Je({key:t,scope:e,method:a,splitKey:"+"})}},Je=({key:t,scope:o,method:e,splitKey:a="+"})=>{Vr(t).forEach(r=>{let l=r.split(a),s=l.length,n=l[s-1],g=n==="*"?"*":So(n);if(!M[g])return;o||(o=de());let h=s>1?zr(Ft,l):[],u=[];M[g]=M[g].filter(m=>{let I=(e?m.method===e:!0)&&m.scope===o&&hc(m.mods,h);return I&&u.push(m.element),!I}),u.forEach(m=>Za(m))})};function Er(t,o,e,a){if(o.element!==a)return;let i;if(o.scope===e||o.scope==="all"){i=o.mods.length>0;for(let r in tt)Object.prototype.hasOwnProperty.call(tt,r)&&(!tt[r]&&o.mods.indexOf(+r)>-1||tt[r]&&o.mods.indexOf(+r)===-1)&&(i=!1);(o.mods.length===0&&!tt[16]&&!tt[18]&&!tt[17]&&!tt[91]||i||o.shortcut==="*")&&(o.keys=[],o.keys=o.keys.concat(z),o.method(t,o)===!1&&(t.preventDefault?t.preventDefault():t.returnValue=!1,t.stopPropagation&&t.stopPropagation(),t.cancelBubble&&(t.cancelBubble=!0)))}}function Dr(t,o){let e=M["*"],a=Mr(t);if(t.key&&t.key.toLowerCase()==="capslock"||!(St.filter||Tr).call(this,t))return;if((a===93||a===224)&&(a=91),z.indexOf(a)===-1&&a!==229&&z.push(a),["metaKey","ctrlKey","altKey","shiftKey"].forEach(n=>{let g=ce[n];t[n]&&z.indexOf(g)===-1?z.push(g):!t[n]&&z.indexOf(g)>-1?z.splice(z.indexOf(g),1):n==="metaKey"&&t[n]&&(z=z.filter(h=>h in ce||h===a))}),a in tt){tt[a]=!0;for(let n in Ft)if(Object.prototype.hasOwnProperty.call(Ft,n)){let g=ce[Ft[n]];St[n]=t[g]}if(!e)return}for(let n in tt)Object.prototype.hasOwnProperty.call(tt,n)&&(tt[n]=t[ce[n]]);t.getModifierState&&!(t.altKey&&!t.ctrlKey)&&t.getModifierState("AltGraph")&&(z.indexOf(17)===-1&&z.push(17),z.indexOf(18)===-1&&z.push(18),tt[17]=!0,tt[18]=!0);let r=de();if(e)for(let n=0;n<e.length;n++)e[n].scope===r&&(t.type==="keydown"&&e[n].keydown||t.type==="keyup"&&e[n].keyup)&&Er(t,e[n],r,o);if(!(a in M))return;let l=M[a],s=l.length;for(let n=0;n<s;n++)if((t.type==="keydown"&&l[n].keydown||t.type==="keyup"&&l[n].keyup)&&l[n].key){let g=l[n],{splitKey:h}=g,u=g.key.split(h),m=[];for(let C=0;C<u.length;C++)m.push(So(u[C]));m.sort().join("")===z.sort().join("")&&Er(t,g,r,o)}}var St=function t(o,e,a){z=[];let i=Vr(o),r=[],l="all",s=document,n=0,g=!1,h=!0,u="+",m=!1,C=!1;if(a===void 0&&typeof e=="function"&&(a=e),Object.prototype.toString.call(e)==="[object Object]"){let I=e;I.scope&&(l=I.scope),I.element&&(s=I.element),I.keyup&&(g=I.keyup),I.keydown!==void 0&&(h=I.keydown),I.capture!==void 0&&(m=I.capture),typeof I.splitKey=="string"&&(u=I.splitKey),I.single===!0&&(C=!0)}for(typeof e=="string"&&(l=e),C&&Hr(o,l);n<i.length;n++){let I=i[n].split(u);r=[],I.length>1&&(r=zr(Ft,I));let L=I[I.length-1];L=L==="*"?"*":So(L),L in M||(M[L]=[]),M[L].push({keyup:g,keydown:h,scope:l,mods:r,shortcut:i[n],method:a,key:i[n],splitKey:u,element:s})}if(typeof s<"u"&&typeof window<"u"){if(!Mt.has(s)){let I=(v=window.event)=>Dr(v,s),L=(v=window.event)=>{Dr(v,s),Qc(v)};Mt.set(s,{keydownListener:I,keyupListenr:L,capture:m}),xa(s,"keydown",I,m),xa(s,"keyup",L,m)}if(!ne){let I=()=>{z=[]};ne={listener:I,capture:m},xa(window,"focus",I,m)}if(!No&&typeof document<"u"){let I=()=>{z=[];for(let y in tt)tt[y]=!1;for(let y in Ft)t[y]=!1},L=I,v=I;document.addEventListener("fullscreenchange",L),document.addEventListener("webkitfullscreenchange",v),No={fullscreen:L,webkit:v}}}};function vc(t,o="all"){Object.keys(M).forEach(e=>{M[e].filter(i=>i.scope===o&&i.shortcut===t).forEach(i=>{i&&i.method&&i.method({},i)})})}function Za(t){let o=Object.values(M).flat();if(o.findIndex(({element:a})=>a===t)<0&&t){let{keydownListener:a,keyupListenr:i,capture:r}=Mt.get(t)||{};a&&i&&(le(t,"keyup",i,r),le(t,"keydown",a,r),Mt.delete(t))}if(o.length<=0||Mt.size<=0){if(Array.from(Mt.keys()).forEach(i=>{let{keydownListener:r,keyupListenr:l,capture:s}=Mt.get(i)||{};r&&l&&(le(i,"keyup",l,s),le(i,"keydown",r,s),Mt.delete(i))}),Mt.clear(),Object.keys(M).forEach(i=>delete M[i]),ne){let{listener:i,capture:r}=ne;le(window,"focus",i,r),ne=null}No&&typeof document<"u"&&(document.removeEventListener("fullscreenchange",No.fullscreen),document.removeEventListener("webkitfullscreenchange",No.webkit),No=null)}}var Wa={getPressedKeyString:Cc,setScope:jr,getScope:de,deleteScope:Lc,getPressedKeyCodes:Ic,getAllKeyCodes:pc,isPressed:wc,filter:Tr,trigger:vc,unbind:Hr,keyMap:se,modifier:Ft,modifierMap:ce};for(let t in Wa){let o=t;Object.prototype.hasOwnProperty.call(Wa,o)&&(St[o]=Wa[o])}if(typeof window<"u"){let t=window.hotkeys;St.noConflict=o=>(o&&window.hotkeys===St&&(window.hotkeys=t),St),window.hotkeys=St}var Ya=class Ya extends HTMLElement{connectedCallback(){this._previousScrollPosition=window.scrollY,this._scroller=this.scrollHandler.bind(this),document.addEventListener("scroll",this._scroller),this.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"}),this.removeAttribute("active")})}disconnectedCallback(){document.removeEventListener("scroll",this._scroller)}scrollHandler(o){let e=window.scrollY;window.requestAnimationFrame(()=>{e>400&&e<this._previousScrollPosition-100?(this._previousScrollPosition=e,this.removeAttribute("active")):e>this._previousScrollPosition+100&&(this._previousScrollPosition=e,this.setAttribute("active",!0))})}};customElements.define("wll-back-to-top",Ya);var Kr=Ya;var Na=class Na extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}connectedCallback(){document.body.classList.contains("wll-code-dark")&&this.classList.add("wa-dark"),this.shadowRoot.innerHTML=`
      <style>
        :host {
...
hotkeys-js/dist/hotkeys-js.js:
   ...
   *)
*/
//# sourceMappingURL=/_bridgetown/static/index.NQ3XUTCY.js.map
